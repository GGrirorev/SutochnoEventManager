...
**Примечания:**
- Для production-окружения рекомендуется использовать Linux
- При активном использовании модуля мониторинга требуется стабильное интернет-соединение
- База данных PostgreSQL может быть размещена на отдельном сервере
